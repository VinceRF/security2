package com.sparta.securityprac.security2.provider;

import com.sparta.securityprac.security2.jwt.HeaderTokenExtractor;
import com.sparta.securityprac.security2.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        if (tokenPayload == null) {
            response.sendRedirect("/user/loginView"); // 로그인 실패하면 여기로 리다이렉트해준다
            return null;
        }
